...
export const StoresSettings = () => {
    ...
    const handleOpenDialog = async (mode: 'create' | 'edit' | 'view', store?: Store) => {
        setDialogMode(mode);
        if (store) {
    ...
    const getDialogTitle = () => {
        switch (dialogMode) {
            case 'create': return 'CREAR TIENDA';
            case 'edit': return 'EDITAR TIENDA';
            case 'view': return 'TIENDA';
            ...
            >
                ...
                <Box sx={{ mb: 3 }}>
                    ...
                    {searchTerm && (
                        ...
                        >
                            {filteredStore.length} tienda {filteredStore.length !== 1 ? 's' : ''} encontrado{filteredStore.length !== 1 ? 's' : ''}
                        </Typography>
                    )}
                </Box>
